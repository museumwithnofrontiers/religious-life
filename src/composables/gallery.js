...
// `useGalleryData.js` used to be byte-identical local copies of what religious-life
...
// legacy project key, no UUID — religious-life shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (religious-life-data 1.0.11+), an outside
