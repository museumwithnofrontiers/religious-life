...
export default {
  ...
  home: {
    title: 'religiousLife.identity.title',
    intro: 'religiousLife.home.intro',
    cards: [
      {
        title: 'religiousLife.nav.catalogue',
        description: 'religiousLife.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'religiousLife.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'religiousLife.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'religiousLife.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'religiousLife.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'religiousLife.partnerObjects.emptyPartner',
  //         emptyInstitution: 'religiousLife.partnerObjects.emptyInstitution',
  //         institutionSummary: 'religiousLife.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'religiousLife.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'religiousLife.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
