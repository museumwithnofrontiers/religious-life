...
The **Museum With No Frontiers — Religious Life** gallery, built from the published
dataset `@museumwnf/religious-life-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/religious-life-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/religious-life/> through the reusable workflows in
